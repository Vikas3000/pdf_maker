...
import 'package:automatic_pdf_maker/hindi_text.dart';
...
class HindiPdf extends StatefulWidget {
  const HindiPdf({super.key});

  @override
  State<HindiPdf> createState() => _HindiPdfState();
}

class _HindiPdfState extends State<HindiPdf> {
  ...
  Future<Uint8List> myPdfView(PdfPageFormat format) async {
    ...
    String summary = AppConstantsHindi.summary;
    String summaryPointone = AppConstantsHindi.summaryPointone;
    String descriptionPoinOne = AppConstantsHindi.descriptionPoinOne;
    String editorialBasedMcq = AppConstantsHindi.editorialBasedMcq;
    String editorialBasedMainsQuestion =
        AppConstantsHindi.editorialBasedMainsQuestion;
    String questionOneMainsQuestion = AppConstantsHindi.questionOneMainsQuestion;
    String questionTwoMainsQuestion = AppConstantsHindi.questionTwoMainsQuestion;
    String answer = AppConstantsHindi.answer;
    String mainsConclusion = AppConstantsHindi.mainsConclusion;
    String mainsConclusionTwo = AppConstantsHindi.mainsConclusionTwo;
    String mainsChallenges = AppConstantsHindi.mainsChallenges;
    String mainsChallengesTwo = AppConstantsHindi.mainsChallengesTwo;
    String mainsOpportunities = AppConstantsHindi.mainsOpportunities;
    String mainsOpportunitiesTwo = AppConstantsHindi.mainsOpportunitiesTwo;
    String introduction = AppConstantsHindi.introduction;
    String mainsIntroductionTwo = AppConstantsHindi.mainsIntroductionTwo;
    String mainsIntroduction = AppConstantsHindi.mainsIntroduction;
    String pyqPrelimsQuestionOne = AppConstantsHindi.pyqPrelimsQuestionOne;
    String pyqPrelimsQuestionTwo = AppConstantsHindi.pyqPrelimsQuestionTwo;
    String pyqPrelimsQuestionTwod = AppConstantsHindi.pyqPrelimsQuestionTwod;
    String pyqOptions = AppConstantsHindi.pyqOptions;
    String pyqStatementOne = AppConstantsHindi.pyqStatementOne;
    String pyqStatementTwo = AppConstantsHindi.pyqStatementTwo;
    String mainsPyqQuestionOne = AppConstantsHindi.mainsPyqQuestionOne;
    String mainsPyqQuestionTwo = AppConstantsHindi.mainsPyqQuestionTwo;
    String mainsPyqQuestionYearOne = AppConstantsHindi.mainsPyqQuestionYearOne;
    String mainsPyqQuestionYearTwo = AppConstantsHindi.mainsPyqQuestionYearTwo;
              ...
              pw.Padding(
                ...
                child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: AppConstantsHindi.optionalSubjects
              ...
              pw.Padding(
                ...
                child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Column(
                        crossAxisAlignment: pw.CrossAxisAlignment.start,
                        children: AppConstantsHindi.eassyTopics
                            .map((subject) => _buildBulletPoint(subject))
                            .toList(),
                      ),
                    ]),
        ...
        child: pw.Column(
          children: [
            ...
            pw.Padding(
              ...
              child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: AppConstantsHindi.keyPoints
                    .map((subject) => _buildBulletPoint(subject))
                    .toList(),
              ),
            )
            ...
            pw.Container(
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: AppConstantsHindi.mcqs.asMap().entries.map((entry) {
                      int index = entry.key;
    ...
    ///__________________________ PAGE 8 : __________________________________________
    pdf.addPage(
      pw.Page(
        margin: const pw.EdgeInsets.only(top: 20, bottom: 20),
        build: (context) => pw.Column(
